...
//--------- 
function initParticlePosition(positions,i) {
  const angle = Math.random() * Math.PI * 2;
  positions[i * 3] = originRadius * Math.cos(angle);  // x
  positions[i * 3 + 1] = originRadius * Math.sin(angle);  // y
  positions[i * 3 + 2] = 0;  // z (plan 2D)
}
//--------- 
function initParticleDirection(directions,i) {
...
//--------- 
function initParticleSpeed(speeds,i) {
  speeds[i] = 0.1 + Math.random() * 0.05;
}

//--------- Main 
const particleCount = 1000;
const originRadius = 1
